...
<script>
  ...
  <script>
    function showJobs() { //javascript
      ...
      output.style.display = "block"; //runs when button is clicked, gets the selected field from dropdown, displays relevant jobs in #joboutput div
    }
  </script>
